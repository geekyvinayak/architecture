...
const ProjectSection = () => {
  const projects = [
    ...
    { id: 3, src: 'https://www.floridaleathergallery.com/blog/wp-content/uploads/sites/116/2020/12/moderninteriordesign.jpg', alt: 'Project 3', colSpan: 'lg:col-span-2', rowSpan: 'lg:row-span-1' },
